...
//import com.cnpay.tigerbalm.utils.notify.NotifyUtil;
//
///*import butterknife.Bind;
//import butterknife.ButterKnife;
//import butterknife.OnClick;*/
//
//import static com.cnpay.tigerbalm.utils.notify.NotifyUtil.context;
//
///**
...
//                    public void run() {
//
//                        Bitmap bitmapFromUri = BitmapFactory.decodeResource(context.getResources(), R.mipmap.ic_launcher);
//                        try {
//                            String portraitUri = "https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1489734223&di=f7aaecb9a64dc7feb874e6723dc6b848&imgtype=jpg&er=1&src=http%3A%2F%2Fimg.zhaogexing.com%2Ftouxiang%2F131124%2F1-131124132517-50.jpg";
//                            //必须asBitmap()
//                            bitmapFromUri = Glide.with(context).load(portraitUri).asBitmap().centerCrop().into(500, 500).get();
//                        } catch (Exception e) {
//                            e.printStackTrace();
