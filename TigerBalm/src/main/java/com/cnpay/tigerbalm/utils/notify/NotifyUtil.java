package com.cnpay.tigerbalm.utils.notify;
...
import com.cnpay.tigerbalm.utils.notify.builder.BigPicBuilder;
import com.cnpay.tigerbalm.utils.notify.builder.BigTextBuilder;
import com.cnpay.tigerbalm.utils.notify.builder.MailboxBuilder;
import com.cnpay.tigerbalm.utils.notify.builder.MediaBuilder;
import com.cnpay.tigerbalm.utils.notify.builder.ProgressBuilder;
import com.cnpay.tigerbalm.utils.notify.builder.SingleLineBuilder;
...
public class NotifyUtil {
    ...
    public static ProgressBuilder buildProgress(int id, int smallIcon, CharSequence contentTitle, int progress, String tag) {
        ProgressBuilder builder = new ProgressBuilder();
        builder.setBase(smallIcon, contentTitle, progress + tag)
                .setId(id);
        builder.setProgress(max, progress, false);
        return builder;
    }
