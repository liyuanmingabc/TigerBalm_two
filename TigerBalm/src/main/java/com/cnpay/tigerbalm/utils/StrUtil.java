...
public class StrUtil {
    ...
    public static String bankTailNum(String str, int tail) {
        if (StrUtil.isEmpty(str) || str.length() < tail) {
            return "";
        }
        return str.substring(str.length() - tail, str.length());
    }
...
//                }
    ...
    public static List<String> stringToArray(String birthday) {
        ...
        Collections.addAll(itemDataList, split);
        return itemDataList;
    }
